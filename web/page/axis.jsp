	...
	<div class="container" id="main">
		...
		<div class="row c_center">
			<div class="col-md-3" id="left_content">
				...
				<div id="title">
					<h2>
						<a href="${pageContext.request.contextPath}/page/main.jsp">MyBlog</a>
					</h2>
			...
			<%
				/*List<Map<String,String>> axis_list = new LinkedList<>();
				...
				axis_list.add(map1);
				axis_list.add(map2);
				pageContext.setAttribute("axis_list",axis_list);*/
			%>
