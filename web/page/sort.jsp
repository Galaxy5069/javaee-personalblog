    ...
    <div class="row c_center">
        <div class="col-md-3" id="left_content">
            ...
            <div id="list">
                <table class="table table-hover c_center">
                    <tr>
                        <td><a href="/Blog/LoginServlet	"><span class="glyphicon glyphicon-home"></span>
                            &nbsp;&nbsp;首页</a></td>
                    </tr>
                    <tr>
                        <td class="active"><a href="/Blog/SortServlet?get=all"><span
            ...
            <%
                /*Map<String, List<Map<String, String>>> sort_article_map = request.getAttribute("sort_article_map");*/
            %>
        </div>
        ...
        <div class="col-md-7 " id="right_Content">
            ...
            <div class="list-group">
                ...
                <!-- 这里初始化列表 -->
                <c:forEach var="map" items="${requestScope.sort_article_map}">
                    <div class="sort_name">
                        <!-- 分类名字 -->
