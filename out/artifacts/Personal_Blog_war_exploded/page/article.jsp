...
%>
	...
	<div class="container" id="main">
		...
		<div class="head">
			<div id="title">
				<h2>
					<a href="/Blog/LoginServlet">MyBlog</a>
				</h2>
			</div>
		</div>
		...
		<div id="article">
			...
			<div id="a_head ">
				...
				<div class="r_div">
					<h5>
						<span class="glyphicon glyphicon-eye-open">&nbsp;${requestScope.article.visit}&nbsp;</span>
						 <span class="glyphicon glyphicon-heart" id="love">&nbsp;${requestScope.article.star}&nbsp;</span>
						 <span	class="glyphicon glyphicon-comment">&nbsp;${requestScope.article.comment}&nbsp; </span>
					</h5>
				</div>
				<div id="tag">
			...
			<div id="a_content">
			<!-- 引入 show.jsp 显示文章内容 ${requestScope.article.content}-->
	...
	<div id="footer">	
	<a href="/Blog/LoginServlet">MyBlog首页&nbsp;&nbsp;</a>|
	<a href="#">&nbsp;&nbsp;返回顶部</a>
	</div>
	<!-- footer -->
</body>
